...
const key_override_t shift_1_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_1, KC_LT, ~0, MOD_MASK_GUI);
const key_override_t shift_2_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_2, KC_LBRC, ~0, MOD_MASK_GUI);
const key_override_t shift_3_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_3, KC_LCBR, ~0, MOD_MASK_GUI);
const key_override_t shift_4_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_4, KC_LPRN, ~0, MOD_MASK_GUI);
const key_override_t shift_5_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_5, KC_BSLS, ~0, MOD_MASK_GUI);
const key_override_t shift_6_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_6, KC_SLSH, ~0, MOD_MASK_GUI);
const key_override_t shift_7_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_7, KC_RPRN, ~0, MOD_MASK_GUI);
const key_override_t shift_8_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_8, KC_RCBR, ~0, MOD_MASK_GUI);
const key_override_t shift_9_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_9, KC_RBRC, ~0, MOD_MASK_GUI);
const key_override_t shift_0_override = ko_make_with_layers_and_negmods(MOD_MASK_SHIFT,	KC_0, KC_GT, ~0, MOD_MASK_GUI);
